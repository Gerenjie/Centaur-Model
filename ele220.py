...
class EleFields:
    ...
    the attributes are not part of the EleFields class definition.  It may
    be most convenient to use EleFields as an abstract base class for a class
    that defines the needed attributes.  Alternatively the constructor can
    define attributes.
