...
class LeapSeconds:
    ...
    def __init__(self, fn='leap-seconds.list', jd_ref_utc=2415020.5):
        ...
        self.secSinceArray = numpy.array(secSinceList)
        self.leapSecArray = numpy.array(leapSecList)
    ...
    def getLeapSeconds(self, jd_utc):
        ...
        idx = numpy.searchsorted(self.secSinceArray, int(secsSince),
            side='right') - 1
        if idx < 0:
            return 0
        if idx > max_idx:
